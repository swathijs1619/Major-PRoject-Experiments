...
with open('/home/oem/Downloads/New Experiments/ECN OFF - CoDel PIE/ping-codel-on.json') as json_file:
    jsondata = json.load(json_file)
 
full_data = jsondata["left-node-0"][0]["10.0.1.1"]
...
data_file = open('ping-codel-on.csv', 'w', newline='')
